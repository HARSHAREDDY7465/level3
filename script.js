...
  { key: "statecode", label: "Status", editable: true,required: false }
];
...
I need to edit the lookup values in subgrid for suppose { key: "_parentcontactid_value", label: "Customer", editable: false }, this is a lookup for contact I need to search for the name and set the contact in the subgrid and while entering the name of the contact it should show related records for every letter is pressed
